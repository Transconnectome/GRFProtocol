### ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
### 01   | simulation
###      | train-data-simulation.R
### ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
### [NOTE]  
### This is a data simulation code for train dataset
### ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
### Train-sets are used in both seed-ensemble and 
### backward-elimination analyses. 
### ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
### written by
### ---
...
# >> II-3-a. data_nonlin_strong ####
data_nonlin_strong <- create_sim_data(
  beta_0 = 0.7, 
  beta_k = 0.4, 
  gamma = 7, 
  gamma_0 = 0.4,
...
# >> II-3-c. data_lin_strong ####
data_lin_strong <- create_sim_data(
  beta_0 = 0.1, 
  beta_k = 0.4, 
  gamma = 5, 
  gamma_0 = 0.4,
...
write.csv(data_nonlin_strong, 'data/train_nonlin_strong.csv')
write.csv(data_nonlin_weak, 'data/train_nonlin_weak.csv')
write.csv(data_lin_strong, 'data/train_lin_strong.csv')
write.csv(data_lin_weak, 'data/train_lin_weak.csv')